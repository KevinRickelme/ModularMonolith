...
{
    public class GetEmpresaFuncionarioByFuncionarioIdQueryHandler(IEmpresaFuncionarioReadRepository empresaFuncionarioRepository, IMapper mapper) : IQueryHandler<GetEmpresaFuncionarioByFuncionarioIdQuery, IEnumerable<EmpresaFuncionarioDTO>>
    {
